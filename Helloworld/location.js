...
LocationInfo. sheng = function (id) {
    if(typeof(items[id]) == "undefined")
        return false;
    return items[id];
};
LocationInfo.shi = function (shengid) {
    const id ='0,'+shengid;
    if(typeof(items[id]) == "undefined")
        return false;
    return items[id];
};
LocationInfo.shengArray = function (id) {
    if(typeof(items[id]) == "undefined")
        return false;
    var arr = items[id];
...
LocationInfo.xian = function (shengid,shiid) {
    const id = '0,'+shengid+','+shiid
    if(typeof(items[id]) == "undefined")
        return false;
    return items[id];
};
